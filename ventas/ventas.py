...
inventario=[
	{'codigo': '1', 'nombre': 'Depositos', 'precio': 351.0, 'cantidad': 20},
	{'codigo': '2', 'nombre': 'Retiros', 'precio': 351.0, 'cantidad': 15}, 
	{'codigo': '3', 'nombre': 'Recaudo', 'precio': 258.0, 'cantidad': 10},
	{'codigo': '4', 'nombre': 'Megared', 'precio': 0, 'cantidad': 20},
	{'codigo': '5', 'nombre': 'Puntored', 'precio': 0, 'cantidad': 5},
	{'codigo': '6', 'nombre': 'Maquina', 'precio': 200.0, 'cantidad': 25},
	{'codigo': '7', 'nombre': 'No monetarios', 'precio': 100.0, 'cantidad': 30},
	{'codigo': '8', 'nombre': 'jabón para trastes', 'precio': 65.0, 'cantidad': 5},
	{'codigo': '9', 'nombre': 'refresco 600ml', 'precio': 15.0, 'cantidad': 10}
]
...
class CambiarCantidadPopup(Popup):
	...
	def validad_input(self, texto_input):
		try:
...
class VentasWindow(BoxLayout):
	...
	def pagar(self):
		if self.ids.rvs.data:
			...
			self.ids.notificacion_falla.text='Aun no esta cuadrado en caja'

	def pagado(self):
		self.ids.notificacion_exito.text='Usted esta cuadrado en caja'
